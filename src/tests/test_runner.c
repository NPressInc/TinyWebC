...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        ...
        // Run discovery router tests
        printf("Running discovery router tests...\n");
        if (discovery_test_main() == 0) {
            printf("✓ Discovery router tests passed\n");
            tests_passed++;
        } else {
            printf("✗ Discovery router tests failed\n");
            tests_failed++;
        }
        printf("\n");
